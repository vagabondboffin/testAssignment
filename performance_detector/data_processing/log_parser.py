...
SERVICES_TO_MONITOR = ['cat-api', 'cat-recommender-api', 'otel_collector',
                       'grafana', 'cat-api-postgres', 'prometheus', 'jaeger']
        ...
        for line in iter(process.stdout.readline, ''):
            ...
            if line:
                ...
                if service and log_message:
                    ...
                    category = categorize_log_line(line, service)
                    if category:
...
def categorize_log_line(line, service):
